# Generated by Django 3.1 on 2020-08-05 19:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.CharField(help_text='No date', max_length=255, null=True, verbose_name='Date')),
                ('isMissing', models.BooleanField(verbose_name='Absent')),
                ('reason', models.CharField(blank=True, help_text='No excuse', max_length=255, verbose_name='Excuse')),
